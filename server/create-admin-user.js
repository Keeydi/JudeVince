...
// BantayPlaka: Admin user credentials (create one admin; add guards via User Management)
const adminEmail = 'admin@bantayplaka.local';
const adminPassword = 'BantayPlaka123!';
...
try {
  ...
  console.log('   Email: admin@bantayplaka.local');
  console.log('   Password: BantayPlaka123!');
