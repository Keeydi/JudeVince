  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (selectedUser) {
        ...
        const role = formData.role === 'admin' ? 'guard' : formData.role;
            ...
            <div className="space-y-2">
              ...
              {selectedUser ? (
                <>
                  <Input
                    id="role"
                    value={selectedUser.role === 'admin' ? 'Admin' : 'Guard'}
                    disabled
                ...
                <>
                  <Select
                    value={formData.role === 'admin' ? 'guard' : formData.role}
                    onValueChange={(value: 'guard') => setFormData({ ...formData, role: value })}
                    disabled={isSubmitting}
                  >
                  ...
                  <p className="text-xs text-muted-foreground">
                    New users are created as Guard. Admin can manage users and settings.
                  </p>
                </>
              )}
            </div>
